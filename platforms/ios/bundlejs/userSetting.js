...
__vue_options__.__file = "/Users/Zhang/Documents/MyGit/friendGroup/src/userSetting.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-32d107c1"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    wxcCellClicked: function wxcCellClicked(e) {
      ...
      imagePicker.pick(function (file) {
        (0, _index.uploadFile)(file.name, file.url).then(function (_ref) {
          var data = _ref.data;

          if (data.state) {
            var imageUrl = data.info;
            (0, _index.setUserAvatar)(_this2.userInfo.id, imageUrl).then(function (_ref2) {
              var data = _ref2.data;
              ...
              if (data.state) {
                _this2.userInfo.avatar = imageUrl;
                _index3.default.commit('setUserInfo', _this2.userInfo);
              }
            }, function (error) {
              console.log(error);
            });
    ...
    wxcButtonClicked: function wxcButtonClicked(e) {
      ...
      (0, _index.setNickname)(this.userInfo.id, this.nickName).then(function (_ref3) {
        var data = _ref3.data;
        ...
        if (data.state) {
          _this3.userInfo.nickname = _this3.nickName;
          _index3.default.commit('setUserInfo', _this3.userInfo);
        }
      }, function (error) {
        console.log(error);
      });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    slot: "value"
  })]) : _vm._e(), (_vm.userInfo) ? _c('wxc-cell', {
    attrs: {
      "label": "昵称",
      "hasArrow": true,
      "hasTopBorder": false
    ...
    on: {
      "input": function($event) {
        _vm.nickName = $event.target.attr.value
      }
    },
    slot: "value"
  }), _c('wxc-button', {
