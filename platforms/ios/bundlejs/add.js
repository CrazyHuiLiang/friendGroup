...
var _index3 = __webpack_require__(246);
...
exports.default = {
  ...
  methods: {
    ...
    addImage: function addImage() {
      ...
      imagePicker.pick(function (image) {
        (0, _index3.uploadFile)(image.name, image.url).then(function (_ref) {
          var data = _ref.data;

          _this.images.push(data.info);
        }, function (error) {
          console.error(error);
        });
      });
    ...
    addMessage: function addMessage() {
      ...
      _index2.default.dispatch('getUserInfo').then(function (userInfo) {
        (0, _index3.addNew)(userInfo.id, _this2.content, _this2.images).then(function (_ref2) {
          var data = _ref2.data;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "wxcMinibarRightButtonClicked": _vm.addMessage
    }
  }), _c('textarea', {
  ...
  }), (_vm.images.length < 9) ? _c('div', {
    staticClass: ["image", "add-image"],
    on: {
      "click": _vm.addImage
    }
  }, [_c('text', {
  ...
  }, [_vm._v("+")])]) : _vm._e()], 2), _c('wxc-loading', {
    attrs: {
