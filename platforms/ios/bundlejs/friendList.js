...
__vue_options__.__file = "/Users/crazyhuiliang/Documents/MyGit/friendGroup/src/friendList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-702d6216"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      attrs: {
        "src": user.avatar || _vm.gConfig.defaultValues.avatar
      }
    }), _c('text', {
      staticStyle: {
        flex: "1",
    ...
    }, [_vm._v(_vm._s(user.nickname || _vm.gConfig.defaultValues.nickName))])])
  })), _c('tab', {
    staticClass: ["tab"],
    attrs: {
      "activeIndex": 0
