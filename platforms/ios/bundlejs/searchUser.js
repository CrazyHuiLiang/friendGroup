...
__vue_options__.__file = "/Users/crazyhuiliang/Documents/MyGit/friendGroup/src/searchUser.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-313046a8"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    ...
    requestAddFriend: function requestAddFriend(e) {
      var _this2 = this;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    ref: "wxc-searchbar",
    on: {
      "wxcSearchbarCancelClicked": _vm.cancelSearch,
      "wxcSearchbarInputReturned": _vm.search
    }
    ...
    attrs: {
      "src": _vm.user.avatar || _vm.gConfig.defaultValues.avatar
    }
  }), _c('text', {
    staticStyle: {
      flex: "1",
  ...
  }, [_vm._v(_vm._s(_vm.user.nickname || _vm.gConfig.defaultValues.nickName))]), _c('wxc-button', {
    attrs: {
      "text": "添加好友",
      "type": "blue",
      "size": "small"
    ...
    on: {
      "wxcButtonClicked": _vm.requestAddFriend
    }
  })], 1)])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
