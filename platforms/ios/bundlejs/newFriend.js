...
__vue_options__.__file = "/Users/crazyhuiliang/Documents/MyGit/friendGroup/src/newFriend.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0fa3fdd5"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    // 查找添加好友的申请
    loadRequests: function loadRequests(e) {
      var _this = this;
    ...
    // 处理好友请求
    handleRequest: function handleRequest(friendId, flag) {
      var _this2 = this;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
    ...
    }, [_vm._v(_vm._s(user.nickname || _vm.gConfig.defaultValues.nickName))]), (user.flag === 0) ? _c('wxc-button', {
      attrs: {
        "text": "添加",
        "type": "blue",
        "size": "small"
      ...
      on: {
        "wxcButtonClicked": function($event) {
          _vm.handleRequest(user.userId, 1)
        }
      }
      ...
      on: {
        "wxcButtonClicked": function($event) {
          _vm.handleRequest(user.userId, 2)
        }
      }
